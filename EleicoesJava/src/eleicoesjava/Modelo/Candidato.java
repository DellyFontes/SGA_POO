...
public class Candidato   extends Eleitor {
    ...
    public Candidato(int numCandidato, String senha, Partido part, Integer numVotosCand, String codigo, boolean votou, int id, String nome, String BI, String genero, String provincia, String Distrito, Date dataNasc) {
